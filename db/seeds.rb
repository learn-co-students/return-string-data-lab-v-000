...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :inventory=> Faker::Number.between(1,100), :description => "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus voluptatum nostrum consequuntur consectetur enim facilis, maxime dicta libero sunt eveniet repellat magni vitae rem quibusdam id, odio asperiores excepturi! Numquam.")
end
5.times do
